...
namespace NegozioStrumentiMusicali
{
    ...
    public static class ClsBatteriaTamburoBL
    {
        ...
        public static long InsertBatteriaTamburo(string stringaDiConnessione, ClsBatteriaTamburo batteriaTamburo, out string comunicazione, bool restituisciEventualiEccezioniAlChiamante = false)
        {
            //VARIABILI
            long _ID = -1;
        ...
        private static ClsBatteriaTamburo CaricaSingoloBatteriaTamburo(ref MySqlDataReader dataReader)
        {
            ...
            _batteriaTamburo.TamburoID = Convert.ToInt64(dataReader["tamburoID"]);
        ...
        /// <returns></returns>
        public static List<ClsBatteriaTamburo> GetSomeBatteriaTamburo(string stringaDiConnessione, out string comunicazione, long batteriaID, long tamburoID)
        {
            //VARIABILI
            comunicazione = String.Empty;
            List<ClsBatteriaTamburo> _listaBatteriaTamburo = new List<ClsBatteriaTamburo>();
        ...
        public static ClsBatteriaTamburo GetOneBatteriaTamburo(string stringaDiConnessione, long batteriaID, long tamburoID, out string comunicazione)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    comunicazione = "Relazione tra batteria e tamburo non trovata nel DataBase";
                }
